    ...
    <footer className="bg-slate-900 text-slate-400 py-8 mt-auto">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between gap-6">
          <div>
            ...
            <p className="text-sm max-w-md leading-relaxed">
              Find drop-in sports sessions at community centres across downtown
              Toronto. Schedules are manually curated and may not reflect the
              latest changes.
            </p>
          </div>
        ...
        <div className="mt-6 pt-4 border-t border-slate-700 text-xs text-slate-500">
          Always verify schedules directly with the community centre before
          visiting.
        </div>
      </div>
    </footer>
